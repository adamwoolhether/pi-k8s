...
then
        ...
        tmux send-keys -t k8s:2.1 'ssh node1' C-m
        tmux send-keys -t k8s:2.2 'ssh node2' C-m
        tmux send-keys -t k8s:2.3 'ssh node3' C-m
        ...
        tmux send-keys -t k8s:3.2 'ssh node1' C-m
        tmux send-keys -t k8s:3.3 'ssh node2' C-m
        tmux send-keys -t k8s:3.4 'ssh node3' C-m
